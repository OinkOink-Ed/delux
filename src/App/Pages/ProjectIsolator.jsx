...
export default function ProjectIsolator() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="parallax-container relative overflow-hidden md:h-[50rem] h-[30rem] flex items-center justify-center mt-24">
        <div
          className="parallax-bg absolute inset-0 bg-[url(/img/Изолятор.jpg)] md:bg-[url(/img/Изолятор.jpg)] bg-cover bg-no-repeat h-[120%] w-full transform-gpu"
          style={{
      ...
      <div className="flex w-full py-10 flex-col gap-10 lg:flex-row lg:gap-0">
        ...
        <div className="flex-[6] self-center justify-items-center px-10">
          <p className="max-w-[600px] font-share-tech-mono">
            Изолятор 3 для размещение обезьян расположенный в
            Научно-исследовательском центре института медицинской приматологии в
            Адлерском районе города Сочи. На данном объекте производилась
            реконструкция здания. Были выполнены отделочные, сантехнические,
            электромонтажные, вентиляционные, фасадные и кровельные работы.
          </p>
        </div>
      </div>
