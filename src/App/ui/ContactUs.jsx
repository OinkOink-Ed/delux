export function ContactUs() {
  return (
    <div
      id="ContactUs"
      className="flex h-auto w-full flex-col items-center gap-12 py-12 px-12"
    >
      <div className="flex min-h-32 flex-wrap max-w-[1600px] gap-8 justify-center">
        ...
        <div className="flex flex-col max-w-[500px] gap-4">
          <h1 className="text-2xl md:text-4xl font-share-tech-mono">
          ...
          <div className="font-share-tech-mono text-md md:text-lg">
            Номер телефона:{" "}
            <a
              href="tel:89184083333"
              className="text-blue-400 active hover:text-blue-600"
            >
              8-918-408-33-33
            </a>
          </div>
          ...
          <div className="font-share-tech-mono text-md md:text-lg">
            Почта:{" "}
            <a
              href="mailto:sk_deluxo@rambler.ru"
              className="text-blue-400 active hover:text-blue-600"
            >
              sk_deluxo@rambler.ru
            </a>
          </div>
          <div className="font-share-tech-mono text-md md:text-lg">
            Телеграм:{" "}
            <a
              href="https://t.me/SkDeluxo"
              className="text-blue-400 active hover:text-blue-600"
            >
              https://t.me/SkDeluxo
            </a>
